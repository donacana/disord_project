...
def verify_answer(question: str, context: str, draft: str) -> str:
    ...
    system_prompt = (
        ...
        '최종 답변은 질문에 답하는 원문 문장을 최대 3개 골라 그대로 옮겨 작성하라.\n'
        '각 문장은 해당 기사 제목 전체 또는 본문의 완전한 문장 하나와 같아야 한다. 조사와 어미도 바꾸지 마라.\n'
        '초안의 표현이 원문과 다르면 근거 원문 문장으로 대체하거나 삭제하라. 주어를 바꾸거나 여러 문장을 합치지 마라.\n'
